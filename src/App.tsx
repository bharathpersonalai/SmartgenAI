      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            {/* This is the container for your new social buttons */}
<div className="flex justify-center items-center gap-4 mt-8">

  {/* WhatsApp Button with original SVG */}
  <button 
    className="Btn whatsapp"
    onClick={() => window.open('https://wa.me/918332010304', '_blank')}
  >
    <div className="sign">
  ...
  {/* Instagram Button with original SVG */}
  <button 
    className="Btn instagram"
    onClick={() => window.open('https://www.linkedin.com/company/smartgenai-innovations/', '_blank')}
  >
    <div className="sign">
      <svg viewBox="0 0 16 16">
  ...
  {/* LinkedIn Button with original SVG */}
  <button 

            ...
            <div className="container mx-auto px-4">
              ...
              <div className="max-w-2xl mx-auto">
                ...
                <div className="flex justify-center items-center gap-4 mt-8">
                  <button className={`Btn whatsapp ${activeButton === 0 ? "expanded" : ""}`} onClick={() => handleButtonClick("https://wa.me/918332010304?text=Hi%20I%20would%20like%20to%20know%20more", 0)}>
                  ...
                  <button className={`Btn instagram ${activeButton === 1 ? "expanded" : ""}`} onClick={() => handleButtonClick("https://www.instagram.com/smartgenaiinnovations?igsh=NTduNHRpaGcybHl1", 1)}>
                  ...
                  <button className={`Btn linkedin ${activeButton === 2 ? "expanded" : ""}`} onClick={() => handleButtonClick("https://www.linkedin.com/company/smartgenai-innovations/", 2)}>

...
const defaultColors: string[] = ['#60a5fa', '#c084fc', '#22d3ee'];
...
const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({ dpr: 2, depth: false, alpha: true });
    ...
    const handlePointerMove = (xPos: number, yPos: number) => {
      const x = (xPos / window.innerWidth) * 2 - 1;
      const y = -(yPos / window.innerHeight) * 2 + 1;

...
const ServicesPage = () => {
  return (
    <div>
      ...
      <main>
        {/* START: Services Section with Video Background */}
        <section id="services" className="relative py-24 overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            ...
            >
              {/* IMPORTANT: Make sure this path matches your video file */}
        ...
        {/* END: Services Section with Video Background */}


        {/* START: Technology Stack Section with Static White Background */}
